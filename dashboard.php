...
$interested_properties = mysqli_fetch_all($result_2, MYSQLI_ASSOC); //convert into array
?>
            ...
            <div class="page-container">
                ...
                ?>
                    <div class="property-card property-id-<?= $property['id'] ?> row">
                     ...
                     <!-- there are many image for each properties -->
